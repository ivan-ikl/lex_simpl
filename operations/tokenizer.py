...
def parse_sentences(corpus):
	"""Splits the text into sentence-wise groups of words (list of lists of words)"""
...
def findNgram(sentece, index, ngrams):
	"""Returns the length of the found n-gram or the individual word if none is found"""
...
def ngrammizeSentences(corpusSentences):
	"""Groups words inside the loaded sentence structure into ngrams using underscores"""
